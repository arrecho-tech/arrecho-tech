...
export interface SiteSetting {
  ...
  /**
   * If a form does not specify a webhook category, this one will be used.
   */
  defaultFormWebhookCategory?: string | null;
  formWebhooks?:
    | {
